...
const seedPosts: Post[] = [
  {
    ...
    html: `
      ...
      <p>A figure circulating widely in 2026 claims teams running 200-plus Appium tests spend 60–70% of QA engineering time fixing broken selectors. It gets repeated as though it were a research finding. It originates in the marketing content of Drizz, a vendor selling an Appium alternative. On most of the pages where it appears it carries no attribution at all; where it is attributed, it points to an unpublished internal "Analysis of 40 Startups, Q4 2025" with no methodology, sample description, or document a reader can inspect. We could find no independent research behind it, and no use of the figure predating Drizz's. So we won't cite it — and we'd encourage you to check the provenance of any number a testing vendor quotes you, ours included.</p>
      <p>Here is what is actually documented, by researchers and engineering teams with nothing to sell you:</p>
      <ul>
        <li><strong>About 60% of mobile test maintenance is repairing what the UI broke.</strong> Coppola, Morisio and Torchiano at Politecnico di Torino studied Android GUI test suites and found that test code "has to be modified often," and that "a relevant portion (60% on average) of such modifications are induced by fragility" — repair work caused by interface change rather than new coverage. Peer-reviewed, Android-specific, and the properly sourced version of the number the vendor blogs invented.</li>
        <li><strong>What that costs in practice.</strong> Slack's engineering team — 16,000+ automated Android tests, 11,000+ on iOS, 550+ pull requests a week — reported that 57% of their CI failures "failed due to test job failures consisting of flaky and failing automated tests," and that "each test failure takes about 28 minutes to manually triage." Fixing it recovered 553 hours of triage time. Mobile-specific, operational, and from a company that sells chat.</li>
        <li><strong>A named engineering team's own number.</strong> Uber's DragonCrawl team wrote that engineers working on mobile testing "invest 30–40% of their time on maintenance," with tests "not immune to frequent disruptions caused by minor updates, such as new pop-ups and changes in buttons." That is lower than the vendor figure — which is rather the point.</li>
        <li><strong>Even Google — and emulators are its flakiest rung.</strong> Google reported in 2017 that of roughly 4.2 million continuous-integration tests, about 63,000 (some 1.5%) had a flaky run in a given week. In the same post's per-tool breakdown, Android emulator tests were the flakiest category measured, at 25.46%.</li>
        <li><strong>Most CI failures aren't defects at all.</strong> A study of Chromium's continuous integration (an arXiv preprint, so not peer-reviewed) analysed more than a million test failures across 2,000 builds and found that "false alerts represent more than 81% of the failures detected in the Chromium CI, whereas legitimate failures only represent 19%." That is a desktop browser project rather than a mobile app — but the ratio is the signal-to-noise problem in a single line.</li>
        <li><strong>And flakiness is structural, not a discipline problem.</strong> Interviews with practitioners found that flakiness "stems from interactions between the system components, the testing infrastructure, and external factors," not merely from carelessly written tests. An Android-specific study put 22% of flaky commits down to "the usage of certain hardware, Android OS version, or a third-party library" — and found 13% of commits simply skipped or removed the flaky test rather than fixing it.</li>
      </ul>
      <p>One thing we looked for and could not find: a credible industry survey of mobile test maintenance cost, with published methodology, from a publisher that is not selling the solution its findings imply. That space is occupied almost entirely by testing vendors. We would rather tell you that than dress one up.</p>
      ...
      <h2>Sources</h2>
      <p><em>Peer-reviewed and academic:</em></p>
      <ul>
        <li>Coppola, Morisio &amp; Torchiano, <a href="https://ar5iv.arxiv.org/html/1711.03565" target="_blank" rel="noopener noreferrer">Scripted GUI Testing of Android Apps: A Study on Diffusion, Evolution and Fragility</a>, PROMISE '17 — the 60% fragility-induced maintenance figure.</li>
        <li>Wei, Liu &amp; Cheung, <a href="https://home.cse.ust.hk/~scc/publ/ase16-FicFhinder-preprint.pdf" target="_blank" rel="noopener noreferrer">Taming Android Fragmentation: Characterizing and Detecting Compatibility Issues for Android Apps</a>, ASE '16 — 59% of 191 compatibility issues were device-specific. See also <a href="https://arxiv.org/abs/2408.01810" target="_blank" rel="noopener noreferrer">Demystifying Device-specific Compatibility Issues in Android Apps</a> (2024).</li>
        <li>Thorve, Sreshtha &amp; Meng, <a href="https://people.cs.vt.edu/nm8247/publications/empirical-study-flaky-pdf.pdf" target="_blank" rel="noopener noreferrer">An Empirical Study of Flaky Tests in Android Apps</a>, ICSME 2018 — hardware and OS variation as a source of flakiness.</li>
        <li>Habchi et al., <a href="https://arxiv.org/abs/2112.04919" target="_blank" rel="noopener noreferrer">A Qualitative Study on the Sources, Impacts, and Mitigation Strategies of Flaky Tests</a>, ICST 2022 — qualitative, 14 practitioner interviews.</li>
        <li>Haben et al., <a href="https://arxiv.org/abs/2111.03382" target="_blank" rel="noopener noreferrer">Discerning Legitimate Failures From False Alerts: A Study of Chromium's Continuous Integration</a> — arXiv preprint, not peer-reviewed; the 81%/19% false-alert split.</li>
      </ul>
      <p><em>Engineering teams reporting on their own systems:</em></p>
      <ul>
        <li><a href="https://slack.engineering/handling-flaky-tests-at-scale-auto-detection-suppression/" target="_blank" rel="noopener noreferrer">Slack Engineering, Handling Flaky Tests at Scale</a> (2022) — mobile CI failure rates and 28-minute manual triage cost.</li>
        <li><a href="https://www.uber.com/blog/generative-ai-for-high-quality-mobile-testing/" target="_blank" rel="noopener noreferrer">Uber Engineering, DragonCrawl</a> (2024) — 30–40% of engineering time on mobile test maintenance.</li>
        <li><a href="https://shopify.engineering/mobile-e2e-testing" target="_blank" rel="noopener noreferrer">Shopify Engineering, How we raised mobile end-to-end test stability to 98%</a> — a suite pulled from PR checks at 50% stability.</li>
        <li><a href="https://testing.googleblog.com/2017/04/where-do-our-flaky-tests-come-from.html" target="_blank" rel="noopener noreferrer">Google Testing Blog, Where do our flaky tests come from?</a> (2017) — 63,000 of 4.2M tests flaky weekly; Android emulator the flakiest tool measured.</li>
      </ul>
      <p>Figures are as reported by each source and linked so you can check them. Where a source sells testing tooling, we've said so in the text. Mobot's own numbers come from the <a href="/customers/homebase-mobile-qa-automation-with-mobot">Homebase case study</a>.</p>
    `,
