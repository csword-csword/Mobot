    ...
    <>
      <section className="border-b border-black/10">
        <div className="mx-auto max-w-[56rem] px-6 py-24 lg:py-32">
          <div className="flex items-center gap-3 mb-5">
            <p className="eyebrow text-black/40 text-xs uppercase">Mobot Labs</p>
      ...
      <section className="py-20 px-6">
        <div className="mx-auto max-w-[56rem]">
          <p className="eyebrow text-black/40 text-xs uppercase mb-4">The Bridge</p>
      ...
      <section className="py-20 px-6 border-y border-black/10 bg-black/[0.015]">
        <div className="mx-auto max-w-[64rem]">
          <p className="eyebrow text-black/40 text-xs uppercase mb-4 text-center">Who This Is For</p>
          <h2 className="text-2xl sm:text-3xl font-bold mb-12 text-center">Three Fit Profiles</h2>
          <div className="grid md:grid-cols-3 gap-5">
            {fitProfiles.map((p) => (
              <div key={p.title} className="rounded-2xl border border-black/10 bg-white p-8">
