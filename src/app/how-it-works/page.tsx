    ...
    <>
      <section className="border-b border-white/10">
        <div className="mx-auto max-w-[64rem] px-6 py-32 lg:py-40">
          <p className="text-white/40 text-xs uppercase tracking-[0.2em] mb-5">How It Works</p>
          ...
          <p className="text-white/60 text-lg leading-relaxed max-w-[40rem]">
      ...
      <section id="robots" className="py-24 px-6">
        <div className="mx-auto max-w-[64rem] grid md:grid-cols-2 gap-12 items-center">
          <div>
            <p className="text-white/40 text-xs uppercase tracking-[0.2em] mb-4">The Robots</p>
          ...
          <div className="rounded-2xl overflow-hidden border border-white/10 shadow-[0_32px_48px_rgba(0,0,0,0.4)]">
      ...
      <section id="platform" className="py-24 px-6 border-y border-white/10">
        <div className="mx-auto max-w-[64rem]">
          <p className="text-white/40 text-xs uppercase tracking-[0.2em] mb-4">The Platform</p>
          <h2 className="text-3xl font-bold mb-4">Built for repeatability, not one-off runs</h2>
          <p className="text-white/60 leading-relaxed max-w-[40rem]">
      ...
      <section id="team" className="py-24 px-6">
        <div className="mx-auto max-w-[64rem]">
          <p className="text-white/40 text-xs uppercase tracking-[0.2em] mb-4">The Team</p>
      ...
      <section id="process" className="py-24 px-6 border-y border-white/10">
        <div className="mx-auto max-w-[64rem]">
