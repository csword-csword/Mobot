    ...
    <>
      <section className="border-b border-black/10">
        <div className="mx-auto max-w-[56rem] px-6 py-24 lg:py-32">
          <p className="eyebrow text-black/40 text-xs uppercase mb-5">Why Real Devices</p>
          ...
          <p className="text-black/60 text-lg leading-relaxed max-w-[42rem]">
      ...
      <section className="py-20 px-6">
        ...
        <div className="mx-auto max-w-[56rem] mt-12 rounded-2xl bg-black/[0.03] border border-black/10 p-10">
      ...
      <section className="py-20 px-6 border-y border-black/10 bg-black/[0.015]">
        <div className="mx-auto max-w-[56rem]">
          ...
          <p className="text-black/60 leading-relaxed max-w-[42rem] mb-4">
          ...
          <p className="text-black/60 leading-relaxed max-w-[42rem]">
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b border-black/10">
                  <th className="py-3 pr-4 text-xs font-bold uppercase tracking-wide text-black/40">Audience</th>
                  <th className="py-3 pr-4 text-xs font-bold uppercase tracking-wide text-black/40">Their Pain</th>
                  <th className="py-3 text-xs font-bold uppercase tracking-wide text-black/40">What Mobot Delivers</th>
                </tr>
              </thead>
              <tbody>
                {audiences.map((a) => (
                  <tr key={a.who} className="border-b border-black/5">
                    <td className="py-4 pr-4 font-bold align-top whitespace-nowrap">{a.who}</td>
                    <td className="py-4 pr-4 text-black/50 text-sm align-top">{a.pain}</td>
                    <td className="py-4 text-blue-ink text-sm font-semibold align-top">{a.message}</td>
                  </tr>
                ))}
              </tbody>
            </table>
