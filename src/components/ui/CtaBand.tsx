    ...
    <section className="py-24 px-6">
      <Reveal className="mx-auto max-w-[80rem]" variant="scale">
        <div className="relative overflow-hidden rounded-lg bg-[#0a2540] px-8 py-16 sm:px-16 text-center">
          <div className="absolute -top-24 -right-24 w-72 h-72 rounded-full bg-[#6d3fe0]/35 blur-3xl animate-float" aria-hidden />
          <div className="absolute -bottom-24 -left-16 w-64 h-64 rounded-full bg-[#1d4ed8]/30 blur-3xl" aria-hidden />
