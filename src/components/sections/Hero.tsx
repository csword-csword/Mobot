  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[64rem] mx-auto px-6 text-center pt-36 pb-24 text-white">
        <p className="hero-line hero-line-1 eyebrow text-sm text-white/70 mb-6">Physical Mobile Testing</p>
        ...
        <p className="hero-line hero-line-5 max-w-[36rem] mx-auto text-white/70 text-lg leading-relaxed mb-10">
